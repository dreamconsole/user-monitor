            ...
            <div className="min-h-screen w-full lg:grid lg:grid-cols-2">
                <div className="hidden lg:flex flex-col justify-between p-12 text-white relative">
                    ...
                    <div className="relative z-20 mt-auto pb-12">
                        <h1 className="text-4xl font-bold tracking-tight mb-4 drop-shadow-md">Reset Password</h1>
                        <p className="text-lg text-white/90 max-w-md drop-shadow-md">Securely set a new password for your account.</p>
                    </div>
                </div>
